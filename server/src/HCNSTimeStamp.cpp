...
std::time_t 
HCNSTimeStamp::printCurrentTime()
{
...
TimeType 
HCNSTimeStamp::getElaspsedTime() const
{
...
long long 
HCNSTimeStamp::getElaspsedTimeInMicrosecond() const
{
          return this->getElaspsedTime<std::chrono::microseconds>().count();
}

long long 
HCNSTimeStamp::getElaspsedTimeInMillisecond() const
{
          return this->getElaspsedTime<std::chrono::milliseconds>().count();
}

long long 
HCNSTimeStamp::getElaspsedTimeInsecond() const
{
