...
private:
		  ...
		  MemoryAllocator<64, 1000000> m_mem64;	//64B memory space for user, only create 100000 tuple lines
		  MemoryAllocator<128, 1000000> m_mem128;	//128B memory space for user, only create 100000 tuple lines
		  MemoryAllocator<256, 1000000> m_mem256;	//256B memory space for user, only create 100000 tuple lines
		  MemoryAllocator<512, 1000000> m_mem512;	//512B memory space for user, only create 100000 tuple lines
		  MemoryAllocator<1024, 1000000> m_mem1024;	//1024B memory space for user, only create 100000 tuple lines
		  MemoryAllocator<2048, 1000000> m_mem2048;	//2048B memory space for user, only create 100000 tuple lines
		  MemoryAllocator<4096, 1000000> m_mem4096;	//4096B memory space for user, only create 100000 tuple lines
