...
const 
SOCKET& 
_ServerSocket::getServerSocket() const 
{
...
const 
in_addr& 
_ServerSocket::getServerAddr()const
{
          return this->_serverAddr.sin_addr;
}
const 
unsigned short& 
_ServerSocket::getServerPort()const
{
          return this->_serverAddr.sin_port;
}

char* 
_ServerSocket::getMsgBufferHead()
{
          return this->m_szMsgBuffer.get();
}

char* 
_ServerSocket::getMsgBufferTail()
{
          return this->getMsgBufferHead() + this->getMsgPtrPos();
}

unsigned int 
_ServerSocket::getBufRemainSpace() const
{
          return this->m_szRemainSpace;
}

unsigned int 
_ServerSocket::getMsgPtrPos() const
{
          return this->m_szMsgPtrPos;
}

unsigned int 
_ServerSocket::getBufFullSpace() const
{
          return this->m_szMsgBufSize;
}

void  
_ServerSocket::increaseMsgBufferPos(unsigned int _increaseSize)
{
...
void  
_ServerSocket::decreaseMsgBufferPos(unsigned int _decreaseSize)
{
...
void 
_ServerSocket::resetMsgBufferPos()
{
...
unsigned int 
_ServerSocket::getSendPtrPos() const
{
          return this->m_szSendPtrPos;
}

unsigned int 
_ServerSocket::getSendBufFullSpace() const
{
          return this->m_szSendBufSize;
}

unsigned int 
_ServerSocket::getSendBufRemainSpace() const
{
          return this->m_szSendRemainSpace;
}

char* 
_ServerSocket::getSendBufferHead()
{
          return this->m_szSendBuffer.get();
}

char* 
_ServerSocket::getSendBufferTail()
{
          return this->getSendBufferHead() + this->getSendPtrPos();
}

void 
_ServerSocket::increaseSendBufferPos(unsigned int _increaseSize)
{
...
void 
_ServerSocket::decreaseSendBufferPos(unsigned int _decreaseSize)
{
...
void 
_ServerSocket::resetSendBufferPos()
{
...
*------------------------------------------------------------------------------------------------------*/
void 
_ServerSocket::resetPulseReportedTime()
{
...
*------------------------------------------------------------------------------------------------------*/
bool 
_ServerSocket::isServerPulseTimeout(IN long long _timeInterval)
{
...
*------------------------------------------------------------------------------------------------------*/
void 
_ServerSocket::flushSendBufferToServer()
{
